...
```
nu de data uitgezet is in clusters kan er ook gekeken worden of de verschillende clusters ook unieke biomarkers hebben. Hiervoor worden de onderstaande testen uitgevoerd.
```{r vinden cluster biomarkers, eval=FALSE}
...
```{r visualiseren van de cluster markers}
