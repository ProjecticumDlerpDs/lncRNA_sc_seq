...
Deelvraag: Welke lncRNA's komen uit de gecombineerde dataset? 

### Hypothese

Er wordt verwacht dat er lncRNA markers worden geidentifiseerd uit de dataset die betrekking hebben tot de embryogenese. Er wordt verwacht dat dit minder marksers zijn dan wanneer er een lncRNA only analyse wordt gedaan. 
...
```{r visualiseren ruwe data, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="figuur1: blablabal", fig.align='center'}
...
hoeveel lncRNA's worden eruit gefilterd? 
...
Bij een PCA analyse wordt de grote hoeveelheid data vereenvoudigt. Dit wordt gedaan door te kijken welke genen de meeste viariabiliteit tonen. De data kan ook in grafieken worden weergeven voor een vergemakkelijkeren weergaven. hieronder worden de eerse 5 PC's weergeven met daarin 5 features.
...
e85_seuratobject <- FindNeighbors(e85_seuratobject, dims = 1:15)
...
e85_seuratobject <- FindClusters(e85_seuratobject, resolution = 1)

# hierna kunnen de clusters weergeven worden in een Umap. Hier worden weer de eerste 10 PCA's gebruikt. 
e85_seuratobject <- RunUMAP(e85_seuratobject, dims = 1:15)
