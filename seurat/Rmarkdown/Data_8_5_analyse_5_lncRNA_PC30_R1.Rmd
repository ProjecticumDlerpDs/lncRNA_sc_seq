...
e85_seuratobject_30_filterd <- FindNeighbors(e85_seuratobject_filterd, dims = 1:30)
...
e85_seuratobject_30_R1_filterd <- FindClusters(e85_seuratobject_30_filterd, resolution = 1)

# hierna kunnen de clusters weergeven worden in een Umap. Hier worden weer de eerste 30 PCA's gebruikt.
e85_seuratobject_30_R1_filterd <- RunUMAP(e85_seuratobject_30_R1_filterd, dims = 1:30)

# maken van een UMAP.
DimPlot(e85_seuratobject_30_R1_filterd, reduction = "umap", label = TRUE)
```
...
Er is een script van gemaakt zodat dit uitgevoerd kan worden als achtergrond proces. 
...
names(new.cluster.ids) <- levels(e85_seuratobject_30_R1_filterd)
e85_seuratobject_30_R1_filterd <- RenameIdents(e85_seuratobject_30_R1_filterd, new.cluster.ids)
DimPlot(e85_seuratobject_30_R1_filterd, reduction = "umap", label = FALSE, pt.size = 0.5) + theme(legend.text = element_text(size = 4), legend.title = element_text(size = 3))
...
e85_lncRNA <- subset(
  e85_seuratobject_30_R1_filterd,
