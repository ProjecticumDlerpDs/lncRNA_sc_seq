...
```{r pre-procesing, eval=TRUE, include=TRUE, echo=TRUE, warning=FALSE, message=FALSE}
...
```{r visualiseren ruwe data, eval=TRUE, echo=TRUE, warning=FALSE, message=FALSE, fig.cap="QC ruwe data visualisatie in vioplot van nFeature\\_RNA, nCount\\_RNA en percent.mt", fig.align='center', fig.pos='H'}
...
```{r pre-procesing visueel maken, eval=TRUE, echo=TRUE, warning=FALSE, message=FALSE, fig.cap="Scatterplot relatie tussen nCount\\_RNA en percent.mt", fig.align='center', fig.pos='H'}
...
```{r pre-procesing visueel maken 2, eval=TRUE, echo=TRUE, warning=FALSE, message=FALSE, fig.cap="Scatterplot relatie tussen nCount\\_RNA en nFeature\\_RNA", fig.align='center', fig.pos='H'}
...
```{r filteren mitochondriaal RNA, warning=FALSE, echo=TRUE, message=FALSE}
...
De kwaliteit van de cellen is overwegend goed, zoals te zien in figuur 2 en figuur 3.
